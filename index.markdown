...
# Federico Cappelli
|iOS | macOS| Networking | iOT | 3D Printing |

## Apps

- [Torrent Hound](/torrenthound.markdown)

## Articles

- [Effective iOS error management](https://medium.com/@federicocap/effective-ios-error-management-2eea302932ca)
- [iOS Event tracking and analytics with JustTrack](https://medium.com/@federicocap/ios-event-tracking-and-analytics-with-justtrack-e4744709f0be)
